...
<div class="reglog-body"> <!-- Registration form -->
    <form method="post" action="register_form.php" class="my-form">

        <div class="form-content">
          <h3 style="text-align:center">Registration</h3>
            <input type="text" name="Name" class="form-field" placeholder="Username" value="<?= htmlspecialchars($name) ?>" required>
            ...
            <input type="date" name="DoB" class="form-field" required>
            <div class="form-button">
            <input type="submit" value="Enter" name="Submit" class="btn button3">
</div>
        </div>

        <div class="form-footer">
          Already have an account? </br>
            <a href="../login/login.php" class="btn button3">Login</a>
        </div>
