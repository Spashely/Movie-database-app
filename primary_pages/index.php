...
<div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">    <!-- Carousel -->
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleControls" data-bs-slide="next">
    ...
    if (isset($_SESSION['Age'])){
        $query = "SELECT * FROM Movies2 WHERE Age_rating <= $_SESSION[Age] LIMIT 4";
    }
    else {
      $query = "SELECT * FROM Movies2 LIMIT 4";
    }
        ...
        {
		echo"<div class='card'>"; /* Movie cards */
		
			echo"<div class='card-body'>";
      echo"<div class='card-image'>";
					echo "<a href='booking.php?ID={$row["ID"]}'><img src='../images/" . $row['Image'] . "'></a>";
          echo"</div>";
