...
<p>
  You have booked <strong><?= htmlspecialchars($booking['title']) ?></strong><br>
  Tickets: <strong><?= htmlspecialchars($booking['tickets']) ?></strong><br>
</p>
<button onclick="window.print()" class="btn button4 registration-btn">Print ticket</button>
