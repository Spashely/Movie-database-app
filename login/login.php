...
<div class="reglog-body"> <!-- Login form -->
<form method="post" action="login_form.php" class="my-form">
  <div class="form-content">
   <h3 style="text-align:center">Log in</h3>
<input type="text" name="Name" class="form-field" placeholder="Username"  value="<?= htmlspecialchars($name) ?>" required><br/>
      ...
      <input type="submit" value="Enter" name="Submit" class="btn button3">
        ...
        <div class="form-footer">
          Don`t have an account? </br>
            <a href="../register/register.php" class="btn button3">Register</a>
        </div>
</form>
</body>
</html>